...
app.service('goodsService',function($http){
	...
	this.isAuditStatus=function (ids) {
		return $http.get('../goods/isAuditStatus.do?ids='+ids);
	}
	this.isMarketable=function (ids) {
		return $http.get('../goods/isMarketable.do?ids='+ids);
	}
});
